...
@Component({
    selector: 'jhi-booking-my-suffix',
    templateUrl: './booking-my-suffix.component.html'
})
export class BookingMySuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: BookingMySuffix) {
        return item.id;
    }

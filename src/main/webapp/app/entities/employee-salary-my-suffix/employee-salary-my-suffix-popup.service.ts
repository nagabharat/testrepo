...
@Injectable()
export class EmployeeSalaryMySuffixPopupService {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.employeeSalaryService.find(id).subscribe((employeeSalary) => {
                    this.ngbModalRef = this.employeeSalaryModalRef(component, employeeSalary);
                    resolve(this.ngbModalRef);
                });
            } else {
                // setTimeout used as a workaround for getting ExpressionChangedAfterItHasBeenCheckedError
                setTimeout(() => {
                    this.ngbModalRef = this.employeeSalaryModalRef(component, new EmployeeSalaryMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    employeeSalaryModalRef(component: Component, employeeSalary: EmployeeSalaryMySuffix): NgbModalRef {

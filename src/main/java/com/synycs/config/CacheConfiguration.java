...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.synycs.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.synycs.domain.Authority.class.getName(), jcacheConfiguration);

...
import com.synycs.repository.BookingRepository;
import com.synycs.service.BookingService;
import com.synycs.service.dto.BookingDTO;
import com.synycs.service.mapper.BookingMapper;
...
public class BookingResourceIntTest {
    ...
    private static final Double DEFAULT_ADVANCE_PAID = 1D;
    private static final Double UPDATED_ADVANCE_PAID = 2D;
    ...
    public static Booking createEntity(EntityManager em) {
        Booking booking = new Booking()
            ...
            .advancePaid(DEFAULT_ADVANCE_PAID);
        return booking;
    }
    ...
    public void createBooking() throws Exception {
        ...
        assertThat(testBooking.getAdvancePaid()).isEqualTo(DEFAULT_ADVANCE_PAID);
    }
    ...
    public void getAllBookings() throws Exception {
        ...
        restBookingMockMvc.perform(get("/api/bookings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].advancePaid").value(hasItem(DEFAULT_ADVANCE_PAID.doubleValue())));
    }
    ...
    public void getBooking() throws Exception {
        ...
        restBookingMockMvc.perform(get("/api/bookings/{id}", booking.getId()))
            ...
            .andExpect(jsonPath("$.advancePaid").value(DEFAULT_ADVANCE_PAID.doubleValue()));
    }
    ...
    public void updateBooking() throws Exception {
        ...
        updatedBooking
            ...
            .advancePaid(UPDATED_ADVANCE_PAID);
        ...
        assertThat(testBooking.getNumberOfPeople()).isEqualTo(UPDATED_NUMBER_OF_PEOPLE);
        assertThat(testBooking.getAdvancePaid()).isEqualTo(UPDATED_ADVANCE_PAID);
    }

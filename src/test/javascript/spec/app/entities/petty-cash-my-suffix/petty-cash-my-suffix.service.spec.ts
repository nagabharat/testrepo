...
describe('Service Tests', () => {
    ...
    describe('PettyCashMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PettyCashMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/petty-cashes/' + 123);
            });
            it('should return PettyCashMySuffix', () => {

                let entity: PettyCashMySuffix;
                service.find(123).subscribe((_entity: PettyCashMySuffix) => {
                    entity = _entity;
                });

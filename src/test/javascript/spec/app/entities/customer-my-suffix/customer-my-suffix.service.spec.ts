...
describe('Service Tests', () => {
    ...
    describe('CustomerMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CustomerMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/customers/' + 123);
            });
            it('should return CustomerMySuffix', () => {

                let entity: CustomerMySuffix;
                service.find(123).subscribe((_entity: CustomerMySuffix) => {
                    entity = _entity;
                });

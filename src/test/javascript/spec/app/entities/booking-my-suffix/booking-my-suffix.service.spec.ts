...
describe('Service Tests', () => {
    ...
    describe('BookingMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BookingMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/bookings/' + 123);
            });
            it('should return BookingMySuffix', () => {

                let entity: BookingMySuffix;
                service.find(123).subscribe((_entity: BookingMySuffix) => {
                    entity = _entity;
                });

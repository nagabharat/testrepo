...
describe('Service Tests', () => {
    ...
    describe('EmployeeSalaryMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmployeeSalaryMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/employee-salaries/' + 123);
            });
            it('should return EmployeeSalaryMySuffix', () => {

                let entity: EmployeeSalaryMySuffix;
                service.find(123).subscribe((_entity: EmployeeSalaryMySuffix) => {
                    entity = _entity;
                });

...
describe('Service Tests', () => {
    ...
    describe('SalaryComponentMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SalaryComponentMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/salary-components/' + 123);
            });
            it('should return SalaryComponentMySuffix', () => {

                let entity: SalaryComponentMySuffix;
                service.find(123).subscribe((_entity: SalaryComponentMySuffix) => {
                    entity = _entity;
                });

...
describe('Service Tests', () => {
    ...
    describe('MonthOfYearMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MonthOfYearMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/month-of-years/' + 123);
            });
            it('should return MonthOfYearMySuffix', () => {

                let entity: MonthOfYearMySuffix;
                service.find(123).subscribe((_entity: MonthOfYearMySuffix) => {
                    entity = _entity;
                });

...
describe('Service Tests', () => {
    ...
    describe('BillsMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BillsMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/bills/' + 123);
            });
            it('should return BillsMySuffix', () => {

                let entity: BillsMySuffix;
                service.find(123).subscribe((_entity: BillsMySuffix) => {
                    entity = _entity;
                });

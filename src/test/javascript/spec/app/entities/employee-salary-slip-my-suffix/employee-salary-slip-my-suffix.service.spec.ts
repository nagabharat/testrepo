...
describe('Service Tests', () => {
    ...
    describe('EmployeeSalarySlipMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EmployeeSalarySlipMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/employee-salary-slips/' + 123);
            });
            it('should return EmployeeSalarySlipMySuffix', () => {

                let entity: EmployeeSalarySlipMySuffix;
                service.find(123).subscribe((_entity: EmployeeSalarySlipMySuffix) => {
                    entity = _entity;
                });
